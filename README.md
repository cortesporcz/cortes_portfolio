...
# Future Developement
NOTE: It is important to note that this portoflio is not 100 % complete, however, it was made to satisfy requirements for the coding bootcamp. There are many future developments that will include links to actual projects and videos and collaboration cards (these are all marked with placeholders at the moment.)
...
For this module challenge, you’ll need to deploy this application to NetlifyLinks to an external site.
...
# Mock-Up
![alt text](homePagePortfolio.png) <br>
![alt text](contactPagePortfolio.png) <br>
